...
|----------|----------------|----------------|---------------------|-----------------|
| 測試一   | 2<br>2 2<br>1 1 | 2x^2 + x       | 2x^2 + x            | 正指數多項式    |
| 測試二   | 1<br>3 0       | 3              | 3                   | 常數項          |
| 測試三   | 2<br>1 -1<br>2 -2 | 1/x + 2/x^2    | 1/x + 2/x^2         | 負指數多項式    |
| 測試四   | 測試一 + 測試二加法 | 2x^2 + x + 3   | 2x^2 + x + 3        | 加法混合項      |
| 測試五   | 測試一 * 測試二乘法 | 6x^2 + 3x      | 6x^2 + 3x           | 乘法混合項      |
